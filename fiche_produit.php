...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-sm-4 border">
      ...
      <div>
        <h3>localisation</h3>
        <div style="width: 100%"><iframe width="100%" height="400" src="https://maps.google.com/maps?width=100%&amp;height=600&amp;hl=en&amp;q=<?= $produit['adresse']; ?>+<?= $produit['cp']; ?>+<?= $produit['ville']; ?>()&amp;ie=UTF8&amp;t=&amp;z=14&amp;iwloc=B&amp;output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"><a href="https://www.maps.ie/coordinates.html">latitude longitude finder</a></iframe></div><br />
      </div>
    </div>
